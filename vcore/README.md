# Azure DocumentDB + Azure OpenAI Python Developer Guide
...
1. [Load data into Azure Cosmos DB](08_Load_Data/README.md)
1. [Use vector search on embeddings in Azure Cosmos DB](09_Vector_Search_Cosmos_DB/README.md)
