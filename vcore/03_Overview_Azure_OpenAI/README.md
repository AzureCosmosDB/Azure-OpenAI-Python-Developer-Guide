...
While this guide focuses on building intelligent apps using Azure OpenAI combined with Azure DocumentDB, the Azure AI Platform consists of many additional AI services.
